<!-- Generated from commands/a11y-audit.md by scripts/build_adapters.py - do not edit by hand. -->
# Audit a page or component for WCAG 2.2 accessibility issues

Audit accessibility of: the text the user typed after this command (ask if none)
