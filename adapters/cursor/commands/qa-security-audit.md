...
# Defensive security review of code or configuration (OWASP-focused)

Perform a defensive security review of: the text the user typed after this command (ask if none)
