---
description: Create a risk-based test plan for a feature or release
argument-hint: "[feature, ticket, or release]"
---
...
1. If $ARGUMENTS is empty, ask what feature/release to plan and stop.
