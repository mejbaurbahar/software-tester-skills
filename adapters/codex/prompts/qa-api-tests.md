---
description: Build an API test suite from an endpoint, OpenAPI spec, or running service
argument-hint: "[spec path, URL, or endpoint]"
---
<!-- Generated from commands/api-tests.md by scripts/build_adapters.py - do not edit by hand. -->

Create API tests for: $ARGUMENTS
