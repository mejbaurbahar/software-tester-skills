# Testing Strategies - Sharp Edges
...
flaky-async-tests
### **Summary**
Async tests that sometimes pass, sometimes fail
### **Severity**
critical
### **Situation**
...
### **Detection Pattern**
sleep\(|waitForTimeout\(|setTimeout.*expect
...
## Testing Library Wrong Queries

### **Id**
testing-library-wrong-queries
### **Summary**
Using wrong queries leads to brittle tests
### **Severity**
high
### **Situation**
...
mocking-what-you-own
### **Summary**
Mocking internal code instead of external dependencies
### **Severity**
medium
### **Situation**
...
not-testing-loading-states
### **Summary**
Missing tests for loading and transitional states
### **Severity**
low
### **Situation**
