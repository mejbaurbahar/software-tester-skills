...
## Scope Creep Attack Surface

### **Id**
scope-creep-attack-surface
### **Summary**
Audit scope doesn't match actual attack surface
### **Severity**
high
### **Situation**
Security audit misses critical components because scope was defined too narrowly
### **Why**
...
### **Detection Pattern**
scope|boundary|exclude|out.of.scope

## Automated Scanner Blind Spots

### **Id**
automated-scanner-blind-spots
### **Summary**
Automated scanners miss LLM-specific vulnerabilities
### **Severity**
high
### **Situation**
Security scanning tools designed for traditional apps miss AI-specific issues
### **Why**
...
point-in-time-vs-continuous
### **Summary**
Security audit becomes stale immediately after completion
### **Severity**
medium
### **Situation**
Audit findings are accurate at time of test but system changes rapidly
### **Why**
...
### **Detection Pattern**
continuous|monitor|real.time|ongoing
...
compliance-security-gap
### **Summary**
Passing compliance audit doesn't mean secure
### **Severity**
medium
### **Situation**
System is compliant with frameworks but has real vulnerabilities
### **Why**
...
### **Detection Pattern**
compliance|SOC2|ISO|audit|certified