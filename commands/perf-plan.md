---
description: Create a load/performance test plan and script with SLOs
argument-hint: "[service, endpoint, or page]"
---

Create a performance test plan for: $ARGUMENTS
